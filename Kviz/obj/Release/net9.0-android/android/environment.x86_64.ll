...
@application_config = dso_local local_unnamed_addr constant %struct.ApplicationConfig {
	...
	i32 u0x06001abb, ; uint32_t jnienv_initialize_method_token
	i32 u0x06001aba, ; uint32_t jnienv_registerjninatives_method_token
...
@aot_dso_cache = dso_local local_unnamed_addr global [900 x %struct.DSOCacheEntry] [
	...
	%struct.DSOCacheEntry {
		...
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.88_name, ; name: libaot-System.Runtime.Serialization.Formatters.dll.so
		ptr null; void* handle
	}, ; 115
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		i64 u0x2ed2b74036a8317a, ; from name: libaot-Kviz.so
		i64 u0xe5539aa6da1f57fd, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-Kviz.dll.so
		ptr null; void* handle
	}, ; 156
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		i64 u0x3effc43347774bd2, ; from name: Kviz
		i64 u0xe5539aa6da1f57fd, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-Kviz.dll.so
		ptr null; void* handle
	...
	%struct.DSOCacheEntry {
		i64 u0x611662862901bed4, ; from name: aot-Kviz.so
		i64 u0xe5539aa6da1f57fd, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-Kviz.dll.so
		ptr null; void* handle
	...
	%struct.DSOCacheEntry {
		i64 u0x70c9b65c2d5904e0, ; from name: aot-Kviz
		i64 u0xe5539aa6da1f57fd, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-Kviz.dll.so
		ptr null; void* handle
	...
	%struct.DSOCacheEntry {
		i64 u0x78e7a21338087c9a, ; from name: libaot-Kviz
		i64 u0xe5539aa6da1f57fd, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-Kviz.dll.so
		ptr null; void* handle
	...
	%struct.DSOCacheEntry {
		i64 u0xe5539aa6da1f57fd, ; from name: libaot-Kviz.dll.so
		i64 u0xe5539aa6da1f57fd, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-Kviz.dll.so
		ptr null; void* handle
	...
	%struct.DSOCacheEntry {
		i64 u0xe6ce68b26c6ad7df, ; from name: Kviz.so
		i64 u0xe5539aa6da1f57fd, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-Kviz.dll.so
		ptr null; void* handle
	...
	%struct.DSOCacheEntry {
		i64 u0xeb82bd277ff0d999, ; from name: aot-Kviz.dll.so
		i64 u0xe5539aa6da1f57fd, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-Kviz.dll.so
		ptr null; void* handle
	...
	%struct.DSOCacheEntry {
		i64 u0xf0892a08a47646a2, ; from name: Kviz.dll.so
		i64 u0xe5539aa6da1f57fd, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-Kviz.dll.so
		ptr null; void* handle
...
;ApplicationConfig
@.ApplicationConfig.0_android_package_name = private unnamed_addr constant [21 x i8] c"com.companyname.kviz\00", align 16
...
@.DSOCacheEntry.8_name = private unnamed_addr constant [19 x i8] c"libaot-Kviz.dll.so\00", align 16
...
@.DSOCacheEntry.88_name = private unnamed_addr constant [54 x i8] c"libaot-System.Runtime.Serialization.Formatters.dll.so\00", align 16
